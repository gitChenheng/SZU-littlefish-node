...
if (process.env.NODE_ENV === ENV_PROD){
    const options = {
        key: fs.readFileSync(`${process.cwd()}/src/https/2_szu_www.denominator.online.key`),
        cert: fs.readFileSync(`${process.cwd()}/src/https/1_szu_www.denominator.online_bundle.crt`)
    };
